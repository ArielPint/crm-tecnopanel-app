  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-auto p-6">
        {opps.length===0 ? (
          <div className="flex flex-col items-center justify-center h-64 text-gray-400"><div className="text-5xl mb-3 opacity-20">📦</div><p className="text-sm">Sin oportunidades en Cubicacion</p></div>
        ) : (
