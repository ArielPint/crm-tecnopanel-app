...
export default function Credito(){
  ...
  return(
    <div className="flex flex-col h-full">
      <div className="px-6 py-4 border-b border-gray-200 bg-white"><h1 className="text-lg font-bold text-gray-800">Evaluacion Crediticia</h1><p className="text-xs text-gray-500">{opps.length} oportunidades</p></div>
